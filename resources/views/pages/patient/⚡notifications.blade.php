...
<div class="mx-auto max-w-2xl space-y-6 px-4 py-8">
    <div>
        <flux:heading size="xl" class="font-semibold text-[#10B981]">{{ __('patient.menu.notifications') }}</flux:heading>
        ...
        <div class="space-y-3">
            @foreach ($this->notifications as $notification)
                <article @class([
                    ...
                    'border-[#10B981]/30 bg-emerald-50/40' => $notification->read_at === null,
