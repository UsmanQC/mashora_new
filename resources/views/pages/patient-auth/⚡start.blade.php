...
new #[Layout('layouts::patient-auth')] #[Title('Enter your mobile number')] class extends Component
{
...
<div>
    <flux:heading size="xl" class="patient-auth-heading">{{ __('patient_auth.start_title') }}</flux:heading>
    <flux:text class="mt-2">{{ __('patient_auth.start_hint') }}</flux:text>
