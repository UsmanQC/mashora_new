@php
    ...
    $singleLinkClass = match ($variant) {
        ...
        'luxury' => 'inline-flex size-10 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-[0.6875rem] font-bold uppercase tracking-[0.06em] text-slate-700 transition hover:border-emerald-200 hover:text-[#059669]',
...
<a
    ...
    @if (in_array($variant, ['chrome', 'header', 'guest', 'luxury', 'marketing'], true)) data-test="patient-navbar-language-switch" @endif
