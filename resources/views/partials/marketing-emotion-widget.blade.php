<div class="marketing-emotion-widget relative z-10">
    <div class="bg-white/85 backdrop-blur-3xl border border-white/70 p-6 sm:p-8 lg:p-10 rounded-[2rem] lg:rounded-[2.5rem] shadow-premium">
        <div class="mb-8 lg:mb-10">
            <h2 class="text-2xl sm:text-3xl font-display font-bold text-ink mb-3 tracking-tight">كيف يمكننا مساعدتك؟</h2>
            <p class="text-sm sm:text-base text-ink-muted">اختر ما يعبر عنك لنرشدك للرعاية الأنسب فوراً.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5 mb-8 lg:mb-10">
            <button type="button" class="emotion-card bg-surface-subtle/50 border border-slate-100 p-5 lg:p-6 rounded-[1.5rem] flex items-start gap-4 lg:gap-5 text-right cursor-pointer group outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                ...
                <div class="pt-0.5 min-w-0">
                    <h3 class="font-display font-bold text-ink mb-1 group-hover:text-primary transition-colors text-base lg:text-lg">قلق وتوتر</h3>
            ...
            <button type="button" class="emotion-card bg-surface-subtle/50 border border-slate-100 p-5 lg:p-6 rounded-[1.5rem] flex items-start gap-4 lg:gap-5 text-right cursor-pointer group outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                ...
                <div class="pt-0.5 min-w-0">
                    <h3 class="font-display font-bold text-ink mb-1 group-hover:text-primary transition-colors text-base lg:text-lg">اكتئاب وحزن</h3>
            ...
            <button type="button" class="emotion-card bg-surface-subtle/50 border border-slate-100 p-5 lg:p-6 rounded-[1.5rem] flex items-start gap-4 lg:gap-5 text-right cursor-pointer group outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                ...
                <div class="pt-0.5 min-w-0">
                    <h3 class="font-display font-bold text-ink mb-1 group-hover:text-primary transition-colors text-base lg:text-lg">علاقات أسرية</h3>
            ...
            <button type="button" class="emotion-card bg-surface-subtle/50 border border-slate-100 p-5 lg:p-6 rounded-[1.5rem] flex items-start gap-4 lg:gap-5 text-right cursor-pointer group outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                ...
                <div class="pt-0.5 min-w-0">
                    <h3 class="font-display font-bold text-ink mb-1 group-hover:text-primary transition-colors text-base lg:text-lg">تطوير الذات</h3>
            ...
            <div class="flex items-center gap-4 lg:gap-5 w-full sm:w-auto">
                ...
                <div class="min-w-0 text-right">
                    @if (($doctorStats['online'] ?? 0) > 0)
                        <p class="text-sm font-bold text-ink mb-0.5">متاح {{ $doctorStats['online'] }} مختص الآن</p>
                    @else
                        <p class="text-sm font-bold text-ink mb-0.5">{{ $doctorStats['total'] ?? 0 }} مختص مرخص</p>
                    @endif
