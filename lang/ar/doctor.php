...
return [
    ...
    'auth' => [
        ...
        'about' => 'نبذة / تعريف (بالإنجليزية)',
        'about_ar' => 'نبذة / تعريف (بالعربية)',
        ...
        'bank_iban_hint' => 'يتم تعبئة SA تلقائيًا. أدخل الـ 22 حرفًا المتبقية (24 حرفًا إجمالًا).',
        ...
        'cancel' => 'إلغاء',
        'duration_title' => 'مدة الجلسة والسعر',
        'duration_subtitle' => 'اختر مدد الجلسات وحدد سعرًا لكل مدة. ابدأ بإدخال سعر جلسة 15 دقيقة، ويمكن تعبئة المدد الأخرى تلقائيًا.',
        'duration_minutes' => ':minutes دقيقة',
        'duration_price_label' => 'السعر',
        'duration_section_label' => 'مدد الجلسات',
        'appointment_types' => 'طرق التواصل',
        'communication_chat' => 'محادثة',
        'communication_voice_call' => 'مكالمة صوتية',
        'communication_video_call' => 'مكالمة فيديو',
        'accept_instant_appointment' => 'قبول إشعارات الجلسات الفورية',
        'accept_instant_appointment_hint' => 'ستصلك إشعارات عند طلب مريض جلسة فورية.',
        'chat_required' => 'يجب اختيار المحادثة ضمن طرق التواصل.',
        'duration_price_required' => 'يرجى إدخال سعر لكل مدة محددة.',
        'duration_price_invalid' => 'يجب أن يكون لكل مدة محددة سعر صالح وموجب.',
    ...
    'conversation' => [
        ...
        'request_session_start' => 'طلب موافقة على البدء المبكر',
        'session_start_request_sent' => 'تم إشعار المريض للموافقة على البدء المبكر أو الرفض.',
        'session_started_toast' => 'بدأت الجلسة.',
        'session_start_wait_one_hour' => 'يصبح زر بدء الجلسة متاحًا قبل ساعة من الموعد المحدد.',
        'waiting_for_patient_approval' => 'بانتظار موافقة المريض على البدء المبكر.',
        'video' => 'فيديو',
        'voice' => 'صوت',
