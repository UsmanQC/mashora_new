...
return [
    ...
    'follow_up' => [
        ...
        'subtitle' => 'اختر تاريخًا ووقتًا لجلسة المريض القادمة. سيصله إشعار للتأكيد والدفع.',
        ...
        'patient_missing' => 'لا يوجد حساب مريض مرتبط بهذا الموعد.',
        'patient_flow_hint' => 'يجب على المريض تأكيد المتابعة ثم الدفع قبل حجز الموعد.',
        'complete_session_first' => 'أكمل الجلسة أولًا، ثم يمكنك دعوة المريض لموعد متابعة.',
        'pending_title' => 'تم إرسال دعوة المتابعة',
        'pending_body' => 'بانتظار تأكيد المريض والدفع. يمكنك إرسال دعوة جديدة بعد إغلاق هذه الدعوة.',
