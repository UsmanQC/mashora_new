...
return [
    ...
    'payment_embedded_v3_hint' => 'Enter your card below — payment stays on this page.',
    ...
    'payment_ssl_local' => 'Local SSL trust issue (common on WAMP). Set PHP `curl.cainfo` / `openssl.cafile` to a CA bundle, then reload this form.',
