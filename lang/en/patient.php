...
return [
    ...
    'appointments' => [
        ...
        'session_start_request_decline' => 'Decline',
        'session_start_request_approved' => 'You approved the session start request. The specialist can now start the call.',
        'session_start_request_declined' => 'You declined the early session request. The specialist can request again before the scheduled time.',
    ...
    'notifications' => [
        ...
        'session_start_request_title' => 'Session start requested',
        'session_start_request_body' => 'Your specialist asked to begin the session early. Open the app to approve or decline.',
        'session_start_request_message' => 'Dr. :doctor asked to start your session early (scheduled :date at :time). Open the session to approve or decline.',
